...
EditorUi.prototype.showShapePicker = function(x, y, source, callback, direction)
{
	...
	if (cells != null && cells.length > 0)
	{
		...
		div.style.cssText = 'position:absolute;left:' + x + 'px;top:' + y +
			'px;width:70px;border-radius:10px;padding:4px;text-align:center;' +
...
EditorUi.prototype.updateActionStates = function()
{
	...
	// Updates action states
	var actions = ['cut', 'copy', 'delete', 'duplicate', 'toFront', 'toBack', 'lockUnlock'];
