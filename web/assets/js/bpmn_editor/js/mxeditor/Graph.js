...
mxGraph.prototype.defaultEdgeKey = "sequenceFlow";
...
Graph = function(container, model, renderHint, stylesheet, themes, standalone)
{
	...
	if (this.stylesheet != null && this.stylesheet != null && this.stylesheet.styles.defaultEdge != null) {
		this.currentEdgeStyle =  mxUtils.clone(this.stylesheet.styles.defaultEdge);
	} else {
		...
		if (createTarget == null || targetCell != null || (target == null && cloneSource))
		{
			...
			try
			{
				...
				if (this.templates != null) {
					var defaultEdge = this.templates[this.defaultEdgeKey];
				...
				var edge = ((mxEvent.isControlDown(evt) && mxEvent.isShiftDown(evt) && duplicate) ||
					(target == null && cloneSource)) ? null : this.insertEdge(this.model.getParent(source),
						null, defaultEdgeValue, source, realTarget, this.createCurrentEdgeStyle());
...
if (typeof mxVertexHandler != 'undefined')
{
	(function()
	{
		...
		mxConnectionHandler.prototype.createEdgeState = function(me)
		{
			...
			var edge = this.graph.createEdge(null, null, defaultEdgeValue, null, null, style);
		...
		Graph.prototype.loadModelTemplate = function() {
			var node = mxUtils.load(STENCIL_PATH + '/model_template.xml').getDocumentElement();
			var dec = new mxCodec(node.ownerDocument);
