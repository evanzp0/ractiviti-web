...
pub async fn get_bpmn(Path(proc_def_id): Path<String>) -> ApiResult<impl IntoResponse> {

    Ok(Json(json!({ "msg": format!("bpmn get: {}", proc_def_id) })))
}

pub async fn update_bpmn(Path(proc_def_id): Path<String>) -> ApiResult<impl IntoResponse> {

    Ok(Json(json!({ "msg": format!("bpmn udpated: {}", proc_def_id) })))
}

pub async fn delete_bpmn(Path(proc_def_id): Path<String>) -> ApiResult<impl IntoResponse> {

    Ok(Json(json!({ "msg": format!("bpmn deleted: {}", proc_def_id) })))
}
